...
inteiro leva de ~1h a ~2h15 — a etapa 1 é a mais pesada (grid search por série).
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Pipeline completo de previsão de despesas liquidadas."
    )
    parser.add_argument(
    ...
    print("\n" + "=" * 65)
    print("  PIPELINE DE PREVISAO DE DESPESAS LIQUIDADAS — run_all.py")
